...
# Title: Top Block
# Generated: Fri Sep 27 08:25:03 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.noise_gain_0 = noise_gain_0 = 0.1
        self.noise_gain = noise_gain = 0.205
        ...
        self.qtgui_edit_box_msg_0 = qtgui.edit_box_msg(qtgui.INT, '', '', False, True, '')
        ...
        self._noise_gain_0_range = Range(0, 1, 0.01, 0.1, 200)
        self._noise_gain_0_win = RangeWidget(self._noise_gain_0_range, self.set_noise_gain_0, 'noise_gain_0', "counter_slider", float)
        self.top_layout.addWidget(self._noise_gain_0_win)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.nbiot_npss_sync_0, 'npss_sync'), (self.qtgui_edit_box_msg_0, 'val'))
        self.msg_connect((self.qtgui_edit_box_msg_0, 'msg'), (self.blocks_message_debug_0, 'print'))
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_throttle_0_0_0, 0))
    ...
    def get_noise_gain_0(self):
        return self.noise_gain_0

    def set_noise_gain_0(self, noise_gain_0):
        self.noise_gain_0 = noise_gain_0
